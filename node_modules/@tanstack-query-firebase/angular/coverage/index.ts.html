  ...
  function fdcOptionsFn() {
    const passedInOptions =
      typeof queryRefOrOptionsFn === "function"
        ? <span class="branch-0 cbranch-no" title="branch not covered" >queryRefOrOptionsFn()</span>
        : undefined;
&nbsp;
...
&nbsp;
      if (providedOptions?.invalidate) {
        for (const qk of providedOptions.invalidate) {
          let key = qk;
          <span class="missing-if-branch" title="else path not taken" >E</span>if ("name" in (key as object)) {

...
const getDocumentRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.getDocument = function getDocument(dcOrVars, varsOrOptions, options) {
...
const getInsightRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetInsight', inputVars);
}
getInsightRef.operationName = 'GetInsight';
exports.getInsightRef = getInsightRef;

exports.getInsight = function getInsight(dcOrVars, varsOrOptions, options) {
...
const updateProjectMemberRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return mutationRef(dcInstance, 'UpdateProjectMember', inputVars);
}
updateProjectMemberRef.operationName = 'UpdateProjectMember';
exports.updateProjectMemberRef = updateProjectMemberRef;

exports.updateProjectMember = function updateProjectMember(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);

...
@Component({
  selector: 'app-navbar-gestao',
  standalone: true,
  imports: [RouterLink, RouterLinkActive, LogoComponent],
  template: `
    <header class="nav">
      <div class="su-container nav-inner">
        <a routerLink="/gestao/dashboard" class="marca">
          <app-logo />
          <span class="tag">Gestão</span>
        </a>

        <nav class="nav-links">
          <a routerLink="/gestao/dashboard" routerLinkActive="ativo" [routerLinkActiveOptions]="{ exact: true }">Dashboard</a>
          <a routerLink="/gestao/relatos" routerLinkActive="ativo">Relatos</a>
          <a routerLink="/gestao/usuarios" routerLinkActive="ativo">Usuários</a>
          <a routerLink="/gestao/estatisticas" routerLinkActive="ativo">Estatísticas</a>
        </nav>
  ...
  styles: [`
    ...
    .tag { font-size: 11px; font-weight: 700; color: var(--su-blue-600); background: var(--su-blue-100); padding: 3px 9px; border-radius: 999px; }
...
export class NavbarGestaoComponent {
